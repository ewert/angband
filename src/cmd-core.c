...
static const struct command_info game_cmds[] =
{
	...
	{ CMD_FIND_UP, "find up stairs", do_cmd_find_up, false, true, 0},
	{ CMD_FIND_DOWN, "find down stairs", do_cmd_find_down, false, true 0},
	...
	{ CMD_FIGHT, "fight", do_cmd_fight, false, true, 0 }, 
